/**
 * Shared helpers for cron execution log reading + CSV export.
 *
 * Lives outside the [agent]/executions and [agent]/[name]/executions route
 * directories because Next 16 routes only allow HTTP-method exports + a fixed
 * set of config exports — helper functions/types/constants must live in a
 * non-route file. Both routes import from here.
 */
